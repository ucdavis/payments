...
export default class CouponSelectControl extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        return (
            <Modal dialogClassName="account-details-modal modal-lg" isOpen={isModalOpen} onBackdropClick={this.closeModal} onEscape={this.closeModal}>
        ...
        return (
            <div className="modal-body" key={id}>
                <div className="row flex-grow-1">
                    ...
                    { isExpired &&
                        <span className="badge badge-info">expired</span>
                    }
                    ...
                    <div className="col-md-1 d-flex justify-content-end align-items-center">
                        <button className="btn" onClick={() => this.modalPickCoupon(coupon)}>
