...
export default class EditCustomerModal extends React.Component<IProps, IState> {
    ...
    public render() {
        ...
        return (
            <Modal dialogClassName="edit-customer-modal modal-lg" isOpen={isModalOpen} onBackdropClick={onCancel} onEscape={onCancel}>
                ...
                <div className="modal-footer">
                    <div className="flex-grow-1 d-flex justify-content-between align-items-center">
                        ...
                        <button className="btn" onClick={this.onConfirm}>Save</button>
                    </div>
                </div>
            </Modal>
        );
