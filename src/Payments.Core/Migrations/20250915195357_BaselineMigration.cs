...
namespace Payments.Core.Migrationsnamespace Payments.Core.Migrations

{{

    /// <summary>    /// <summary>

    /// Baseline migration for existing database.    /// Baseline migration for existing database.

    /// This migration assumes the database already exists with all tables.    /// This migration assumes the database already exists with all tables.

    /// It serves as a starting point for future schema changes.    /// It serves as a starting point for future schema changes.

    /// </summary>    /// </summary>

    public partial class BaselineMigration : Migration    public partial class BaselineMigration : Migration
    ...
    {
        {
            ...
            // Database already exists with all tables            // Database already exists with all tables

            // This is a baseline migration - no operations needed            // This is a baseline migration - no operations needed
    ...
    {
        {
            ...
            // Cannot downgrade from baseline            // Cannot downgrade from baseline

            throw new NotSupportedException("Cannot downgrade from baseline migration. Database existed before EF migrations were implemented."); throw new NotSupportedException("Cannot downgrade from baseline migration. Database existed before EF migrations were implemented.");
